...
export const CURRENCIES: Record<CurrencyCode, CurrencyInfo> = {
  EUR: { code: "EUR", symbol: "€",  name_ru: "Евро",                rate_to_eur: 1 },
  RUB: { code: "RUB", symbol: "₽",  name_ru: "Российский рубль",    rate_to_eur: 95 },
  UAH: { code: "UAH", symbol: "₴",  name_ru: "Гривна",              rate_to_eur: 45 },
  BYN: { code: "BYN", symbol: "Br", name_ru: "Белорусский рубль",   rate_to_eur: 3.5 },
  KZT: { code: "KZT", symbol: "₸",  name_ru: "Казахстанский тенге", rate_to_eur: 540 },
};
